...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_dir.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        self.btn_dir.setObjectName("btn_dir")
        self.btn_left = QtWidgets.QPushButton(self.centralwidget)
        self.btn_left.setGeometry(QtCore.QRect(150, 490, 121, 51))
        self.btn_left.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        self.btn_left.setObjectName("btn_left")
        self.btn_right = QtWidgets.QPushButton(self.centralwidget)
        self.btn_right.setGeometry(QtCore.QRect(280, 490, 121, 51))
        self.btn_right.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        self.btn_right.setObjectName("btn_right")
        self.btn_flip = QtWidgets.QPushButton(self.centralwidget)
        self.btn_flip.setGeometry(QtCore.QRect(410, 490, 121, 51))
        self.btn_flip.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        self.btn_flip.setObjectName("btn_flip")
        self.btn_sharp = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sharp.setGeometry(QtCore.QRect(540, 490, 121, 51))
        self.btn_sharp.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        self.btn_sharp.setObjectName("btn_sharp")
        self.btn_bw = QtWidgets.QPushButton(self.centralwidget)
        self.btn_bw.setGeometry(QtCore.QRect(670, 490, 121, 51))
        self.btn_bw.setStyleSheet("background-color: rgb(116, 116, 116);\n"
"color: rgb(255, 255, 255);")
        ...
        self.label.setGeometry(QtCore.QRect(166, 70, 621, 401))
